...
def test_fuse_cli_runs_full_pipeline(tmp_path: Path, capsys: object) -> None:
    page = DocumentPage(
        id="doc:1:page:1",
        document_id="doc:1",
        page_number=1,
